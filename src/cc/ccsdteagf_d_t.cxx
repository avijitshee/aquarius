...
template <typename U>
class CCSDTEAGF_D_T : public Iterative<complex_type_t<U>>
{
    protected:
    ...
    public:
        CCSDTEAGF_D_T(const string& name, Config& config)
        : Iterative<CU>(name, config), krylov_config(config.get("krylov"))
        {
            ...
            this->addProduct("ccsd_t.eagf", "gf_ea", reqs);
...
INSTANTIATE_SPECIALIZATIONS(aquarius::cc::CCSDTEAGF_D_T);
REGISTER_TASK(aquarius::cc::CCSDTEAGF_D_T<double>, "ccsdteagf_d_t",spec);
